...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card mt-5">
                <div class="card-header text-white bg-dark">新規登録</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">アカウントネーム</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4 d-flex align-items-center">
                                ...
                                <div class="ml-auto"><a href="{{ route('home') }}">Home に戻る</a></div>
                            </div>
                        </div>
                    </form>
                </div>
